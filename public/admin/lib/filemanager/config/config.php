...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => base_path() . 'images/content/'.$_SESSION['idoffice'].'/',
	...
	|
	*/
	'current_path' => '../../../images/content/'.$_SESSION['idoffice'].'/',  
	...
	|
	*/
	'thumbs_base_path' =>  '../../../images/thumbs/'.$_SESSION['idoffice'].'/',
