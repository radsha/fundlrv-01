        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="<?php echo e(url('index')); ?>"><i class="fa fa-dashboard fa-fw"></i> ทักทาย</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li> <a href="<?php echo e(url('indexadmin')); ?>">1.หน้าแรก</a> </li>
                            <li> <a href="<?php echo e(url('member')); ?>">2.ทะเบียนสมาชิก</a> </li>
                            <li> <a href="<?php echo e(url('fund')); ?>">3.การสมัคร</a> </li>
                            <li> <a href="<?php echo e(url('fundview')); ?>">4.การชำระเงิน</a> </li>
                            <li> <a href="<?php echo e(url('fundgaint')); ?>">5.ผู้รับผลประโยชน์</a> </li>
                            <li> <a href="<?php echo e(url('indexadmin')); ?>">6.ทะเบียนฌาปนกิจ</a> </li>
                            <li> <a href="<?php echo e(url('indexadmin')); ?>">7.ทะเบียนผู้เสียชีวิต</a> </li>
                            <li> <a href="<?php echo e(url('fundfile')); ?>">8.การแทรกไฟล์</a> </li>
                            <li> <a href="<?php echo e(url('fundpic')); ?>">7.การแทรกรูป</a> </li>


                            <li>
                                <a href="#"><i class="fa fa-print fa-fw"></i>  รายงาน <span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li> <a href="<?php echo e(url('indexadmin')); ?>l">1.รายงานรายวัน</a>  </li>
                                </ul>
                            </li>
                            ...
                            <ul class="nav nav-second-level">
                               ...
                               <li>
                                   <a href="#"><i class="fa fa-print fa-fw"></i> การตั้งค่า <span class="fa arrow"></span></a>
                                         <ul class="nav nav-second-level">
                                         <li> <a href="<?php echo e(url('newstype')); ?>" >1.ประเภทเอกสาร</a>  </li>
                                         </ul>
                                 </li>
                            </ul>
                    </li>
<?php if(Auth::guard('admin')->user()->level=='A'): ?>
                  <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> AdminMenu<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                               <li> <a href="<?php echo e(url('menulist')); ?>">เมนู</a>   </li>
                               <li> <a href="<?php echo e(url('userper')); ?>">กำหนดสิทธิ์</a> </li>
                            </ul>
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-print fa-fw"></i> การตั้งค่า <span class="fa arrow"></span></a>
                              <ul class="nav nav-second-level">
                              <li> <a href="<?php echo e(url('fundtype')); ?>" >1.งานฌาปนกิจ</a>  </li>
                              <li> <a href="<?php echo e(url('import')); ?>" >2.การนำเข้าข้อมูล</a>  </li>
                              </ul>
                      </li>
