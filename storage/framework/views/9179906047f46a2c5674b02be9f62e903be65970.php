...
<?php $__env->startSection('header'); ?>
  <a href='<?php echo e(url('fundpic')); ?>' ><i class="fa  fa-arrow-circle-left text-danger" style="font-size:25px"></i></a>
     ...
     <table class="table table-striped table-bordered table-hover">
             <thead>
                 <tr class="info" >
                      ...
                      <th  class="text-center"> <a href='<?php echo e(url('fundpic/create?mbid='.$data2->mbid.'&samano='.Request::input('samano').'&fundid='.Request::input('fundid').'&mbmember='.Request::input('mbmember').'&keywords='.Request::input('keywords'))); ?>' class="btn btn-primary btn-xs"><i class="fa fa-plus-circle"> เพิ่มข้อมูล</i> </a> </th>
                  </tr>
             </thead>
         <tbody>
           <?php $i=0;?>
<?php foreach($data as $data1 ): ?>
  <?php $i++;?>
            <tr>
                      ...
                      <td> <?php echo e($data1->picname); ?> </td>
                      <td class="text-center"> <?php echo e(App\Lib::dateThai($data1->filedate)); ?>  </td>
                      <td class="text-center">	<a href="<?php echo e(url('fileuploads/pic/T'.$data1->filename)); ?>"  class="link1"> <?php echo e($data1->filename); ?></a>  </td>
                      <td class="text-center">
                       <?php if($data1->filedate<date('Ymd')): ?>
                        <a href="<?php echo e(url('fundpic-delete/'. $data1->idpic)); ?>" onclick="return confirm('ยืนยันการลบ')" style="font-size:15px"><i class="fa fa-times text-danger" ></i> </a>
                      <?php endif; ?>
                      </td>
              </tr>
<?php endforeach; ?>
